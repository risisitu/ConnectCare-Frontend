        ...
        <>
            ...
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    <h2 className="text-xl font-bold text-gray-800 dark:text-white">Available Doctors</h2>
                </div>
                                ...
                                <div className="flex items-start justify-between">
                                    <div className="flex items-center gap-3">
                                        <div className="h-14 w-14 overflow-hidden rounded-full bg-gray-100">
                                            {doctor.profileImage ? (
                                                <img src={doctor.profileImage} alt={`${doctor.firstName}`} className="h-full w-full object-cover" />
                                            ) : (
