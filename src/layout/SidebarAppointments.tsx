    ...
    <div className="px-2 py-4 border-t border-gray-100 dark:border-gray-800">
      ...
      {showForm && inlineForm && (
        <div className="mb-4 text-sm text-gray-500">
          <p>To ensure availability, please use the <button onClick={() => navigate('/TailAdmin/doctors')} className="text-blue-600 underline">Find Doctor</button> page to book an appointment.</p>
        </div>
      )}
